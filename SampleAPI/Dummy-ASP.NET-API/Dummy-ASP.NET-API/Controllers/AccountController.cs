...
using Dummy_ASP.NET_API.Models;
using Dummy_ASP.NET_API.Providers;
using Dummy_ASP.NET_API.Results;
...
namespace Dummy_ASP.NET_API.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Route("SetPassword")]
        public async Task<IHttpActionResult> SetPassword([FromBody] SetPasswordBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
